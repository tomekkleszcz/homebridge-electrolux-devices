...
export class Comfort600 extends ElectroluxAccessoryController {
    ...
    async setActive(value: CharacteristicValue) {
        ...
        this.appliance.properties.reported.applianceState = value === this.platform.Characteristic.Active.ACTIVE ? 'running' : 'off';
    }
    ...
    async getCurrentHeaterCoolerState(): Promise<CharacteristicValue> {
        ...
        switch(this.appliance.properties.reported.mode) {
            ...
            case 'auto':
                return this.appliance.properties.reported.ambientTemperatureC > this.appliance.properties.reported.targetTemperatureC ?
                    this.platform.Characteristic.CurrentHeaterCoolerState.COOLING :
                    this.platform.Characteristic.CurrentHeaterCoolerState.HEATING;
        }
    }
    ...
    async setTargetHeaterCoolerState(value: CharacteristicValue) {
        ...
        switch(value) {
            case this.platform.Characteristic.TargetHeaterCoolerState.AUTO:
                mode = 'AUTO';
                currentState = this.appliance.properties.reported.ambientTemperatureC > this.appliance.properties.reported.targetTemperatureC ?
                    this.platform.Characteristic.CurrentHeaterCoolerState.COOLING :
                    this.platform.Characteristic.CurrentHeaterCoolerState.HEATING;
                break;
        ...
        if(currentState) {
            ...
            this.appliance.properties.reported.mode = mode.toLowerCase() as Mode;
        }
    }
    ...
    async setLockPhysicalControls(value: CharacteristicValue) {
        ...
        this.appliance.properties.reported.uiLockMode = value === this.platform.Characteristic.LockPhysicalControls.CONTROL_LOCK_ENABLED;
    }
    ...
    async setRotationSpeed(value: CharacteristicValue) {
        ...
        this.appliance.properties.reported.fanSpeedSetting = value === (0 as number) ? 'auto' :
            numberValue <= 33 ? 'low' :
                numberValue <= 66 ? 'middle' :
                    'high';
    ...
    async setSwingMode(value: CharacteristicValue) {
        ...
        this.appliance.properties.reported.verticalSwing = value === this.platform.Characteristic.SwingMode.SWING_ENABLED ? 'on' : 'off';
    }
    ...
    async setCoolingThresholdTemperature(value: CharacteristicValue) {
        ...
        try {
            ...
            this.appliance.properties.reported.targetTemperatureC = value as number;
        } catch(err) {
            throw new this.platform.api.hap.HapStatusError(this.platform.api.hap.HAPStatus.SERVICE_COMMUNICATION_FAILURE);
        }
    }
